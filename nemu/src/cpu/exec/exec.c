...
make_group(group1_b,
	inv, inv, inv, inv, 
	inv, sub_i2rm_b, inv, cmp_i_rm_b)

/* 0x81 */
make_group(group1_v,
	inv, inv, inv, inv, 
	inv, sub_i2rm_v, inv, cmp_i_rm_v)

/* 0x83 */
make_group(group1_sx_v,
	inv, inv, inv, inv, 
	inv, sub_si2rm_v, inv, cmp_si_rm_v)
...
/* 0xf6 */
make_group(group3_b,
	test_i_rm_b, inv, inv, inv, 
	inv, inv, inv, inv)

/* 0xf7 */
make_group(group3_v,
	test_i_rm_v, inv, inv, inv, 
	inv, inv, inv, inv)
...
/* 0x70 */	inv, jcc_no_b, jcc_b_b, jcc_ae_b,
/* 0x74 */	jcc_e_b, jcc_ne_b, jcc_be_b, jcc_a_b,
/* 0x78 */	inv, jcc_ns_b, inv, jcc_np_b,
...
/* 0x80 */	inv, jcc_no_v, jcc_b_v, jcc_ae_v,
/* 0x84 */	jcc_e_v, jcc_ne_v, jcc_be_v, jcc_a_v,
/* 0x88 */	inv, jcc_ns_v, inv, jcc_np_v, 
