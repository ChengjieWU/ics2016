...
/* 0x80 */
make_group(group1_b,
	add_i2rm_b, inv, adc_i2rm_b, inv, 
	and_i2rm_b, sub_i2rm_b, inv, cmp_i_rm_b)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, inv, adc_i2rm_v, inv, 
	and_i2rm_v, sub_i2rm_v, inv, cmp_i_rm_v)

/* 0x83 */
make_group(group1_sx_v,
	add_si2rm_v, inv, adc_si2rm_v, inv, 
	and_si2rm_v, sub_si2rm_v, inv, cmp_si_rm_v)
