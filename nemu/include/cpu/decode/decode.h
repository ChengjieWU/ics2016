...
make_helper(decode_i_rm_b);//
make_helper(decode_i_rm_w);//
make_helper(decode_i_rm_l);//
...
make_helper(decode_si_rm_w);//
make_helper(decode_si_rm_l);//
...
make_helper(decode_rm_r_b);//
make_helper(decode_rm_r_w);//
make_helper(decode_rm_r_l);//
